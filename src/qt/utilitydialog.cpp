    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Florincoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Florincoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Florincoin Core is shutting down...") + "<br /><br />" +
