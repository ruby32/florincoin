...
// Copyright (c) 2014-2017 The Florincoin and Litecoin developers
...
public:
    ...
    unsigned int nTargetTimespanAdjDown_Version1;
    unsigned int nTargetTimespanAdjDown_Version2;
    unsigned int nTargetTimespanAdjDown_Version3;
